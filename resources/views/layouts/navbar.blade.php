 <nav class="navbar navbar-expand navbar-light topbar static-top mb-4 bg-white shadow">
     ...
     <div class="container">
         <div class="row w-100 justify-content-center">
             <div class="col-12 text-center">
                 <h4 class="font-weight-bold my-2">Metode Analytical Hierarchy Process (AHP)</h4>
             </div>
         </div>
     </div>
     {{-- <!-- Topbar Search -->
     <form class="d-none d-sm-inline-block form-inline ml-md-3 my-md-0 mw-100 navbar-search my-2 mr-auto">
         <div class="input-group">
             <input type="text" class="form-control bg-light small border-0" placeholder="Cari sesuatu..."
