...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <form action="/alternatives/store" method="post">
                @csrf
                @method('POST')
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea cols="10" rows="10" type="text" name="description" id="description"
                                class="form-control @error('description') is-invalid @enderror" value="{{ old('nama') }}"></textarea>
                            @error('description')
